...
SEED_SCORES: list[ScoreLine] = [
    ...
    ScoreLine("黑龙江", "历史类", 2025, 603, 739),  # 位次取自第三方(gk100.com)，非官方
    ScoreLine("江西", "历史类", 2025, 612, 1168),
    ScoreLine("湖北", "历史类", 2025, 616, 1552),  # 位次取自第三方(gaokao.cn)，非官方
    ...
    ScoreLine("安徽", "物理类", 2024, 655, 3863),
    ScoreLine("重庆", "历史类", 2024, 624, 559),
    ScoreLine("四川", "历史类", 2024, 599, 1320),
    ScoreLine("陕西", "历史类", 2024, 602, 488),
    ScoreLine("黑龙江", "物理类", 2024, 645),
    ScoreLine("黑龙江", "历史类", 2024, 619),
    ScoreLine("北京", "综合改革", 2024, 647, 3504),
    ScoreLine("江苏", "物理类", 2024, 649),
    ScoreLine("江苏", "历史类", 2024, 626),
    ScoreLine("辽宁", "物理类", 2024, 663, 1986),
    ScoreLine("辽宁", "历史类", 2024, 632),
    # ── 2023 年（历史参考） ──
